...
<<div class="container-xxl">
    <div class="authentication-wrapper authentication-basic container-p-y"
         style="
                background-image: url('<?php echo e(asset('image/bg.jpeg')); ?>');  
                ...
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="<?php echo e(route('home')); ?>" class="app-brand-link gap-2">
                            <img src="<?php echo e(asset('log.png')); ?>" alt="<?php echo e(config('app.name')); ?>" srcset="" width="75px">
                        </a>
                    </div>
...
<?php /**PATH C:\laragon\www\laravel-surat-menyurat-v1-main\resources\views/pages/login.blade.php ENDPATH**/ ?>