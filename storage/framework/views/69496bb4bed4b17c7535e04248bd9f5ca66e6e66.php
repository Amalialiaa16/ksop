<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="<?php echo e(route('home')); ?>" class="app-brand-link">
            <img src="<?php echo e(asset('log.png')); ?>"width="38">
            <span class="app-brand-text demo text-black fw-bolder ms-2" style="font-size: 23px;">Web Arsip Digital</span>
        </a>
...
<?php /**PATH C:\laragon\www\laravel-surat-menyurat-v1-main\resources\views/components/sidebar.blade.php ENDPATH**/ ?>